...
| Story | Title | Status |
| --- | --- | --- |
| [`NFA-001`](stories/NFA-001-establish-the-repository-baseline.md) | Establish the repository baseline | Planned |
| [`NFA-002`](stories/NFA-002-build-the-spring-boot-app-shell.md) | Build the Spring Boot app shell | Planned |
| [`NFA-003`](stories/NFA-003-build-the-angular-app-shell-and-token-flow.md) | Build the Angular app shell and token flow | Planned |
| [`NFA-004`](stories/NFA-004-add-postgresql-and-flyway.md) | Add PostgreSQL and Flyway | Planned |
